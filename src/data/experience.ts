...
export const experience: ExperienceItem[] = [
  ...
  // Certifications — issue dates confirmed by Bea on 2026-08-27 against the
  // Credly, Microsoft Learn, and GARP credential pages linked on each card.
  // `date` is the display string; `year` drives filtering and sorting.
  {
    kind: "Certification",
  ...
  },
  {
    ...
    description: "Expired December 2025.",
